...
class TimeUtils {
    ...
    static func getCurrentTime(adjustedTimeHours: Int, adjustedTimeMinutes: Int, adjustedTimeSeconds: Int, minutesInAHour: Int, secondsInAMinute: Int) -> DateComponents {
